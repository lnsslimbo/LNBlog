...
public class UserDao {
	...
	public String addUser(User user){
		...
		if(user.getUserName().length()>=3 && user.getPassword1().length()>8 && user.getPassword2().length()>8 && user.getPassword1().equals(user.getPassword2()) && (user.getGender().equals("男") || user.getGender().equals("女") && user.getGender() != "")){
	...
	public String changeUser(User user){
		...
		try {
		    ...
		    if(user.getTel().length() == 11 && (user.getGender().equals("女") || user.getGender().equals("男")) && user.getCondition().equals("启用") || user.getCondition().equals("禁用")){
