        ...
        <table class="table table-bordered">
            ...
            <c:forEach items="listUser" var="user">
                <tr>
                    ...
                    <td>${listUser.weChat }</td>
                    <td>${listUser.information }</td>
                    <td>${listUser.signDate }</td>
                    <td>${listUser.condition }</td>
                    <td>${listUser.position }</td>
                </tr>
            </c:forEach>
            
            <tr>
              <td colspan="11"><a href="MainServlet" class="btn btn-primary text-center">返回主页</a></td>
            </tr>
        </table>
