<%@ page language="java" import="java.util.*" import="com.zhw.entity.Article"  pageEncoding="utf-8"%>
<%
...
<html>
  <head>
	...
	<style>
	   ...
	   .form-control-feedback {right:40px;
	                              line-height: 140px;}
  ...
  <body>
    ...
    <script src="html/js/bootstrap.min.js"></script>
            ...
            <form action="SelfArticleServlet?userName=<%=request.getAttribute("userName") %>" method="get" >
                <input type="text"  placeholder="请输入用户名" name="userName" value="${userName }" class="form-control">
		...
		<table class="table table-bordered">
			...
			<%
			 ...
			 <tr>
			     ...
			     <td>
			         <a href="ShowArticleServlet?articleID=<%=article.getArticleID()%>"><button class="btn btn-primary">显示信息</button></a>
			         <a href="DeleteArticleServlet?articleID=<%=article.getArticleID()%>" onclick="return confirm('确认删除？');"><button class="btn btn-primary">删除</button></a>
			         <a href="OnArticleServlet?articleID=<%=article.getArticleID()%>"><button class="btn btn-primary">启用</button></a>
			         <a href="OffArticleServlet?articleID=<%=article.getArticleID()%>"><button class="btn btn-primary">禁用</button></a>
			     </td>
			 </tr>
