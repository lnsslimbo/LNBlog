  ...
  　    </div>
	    ...
	    <ul id="menu" class="nav nav-justified">
		    ...
		    <li class="dropdown">
			    ...
			    <ul class="dropdown-menu">
					<li><a href="LoginServlet">修改密码</a></li>
					<li><a href="LoginServlet">我的信息</a></li>
			    </ul>
			</li>
			...
			<li><a href="LoginServlet">登录</a></li>
			<li><a href="SignServlet">注册</a></li>
    ...
    <div id="container">
        ...
        <div id="side" style="width:250px;height:300px; text-align:center;" class="demo">
			<form action="IndexServlet" method="post" class="form-horizontal">
	    <h1 class="text-center text-info">登录</h1><br>
		<div class="form-group has-feedback">
			<div class="username">
				<span class="glyphicon glyphicon-user form-control-feedback"></span>&emsp;&emsp;
		...
		<div class="form-group pwd-top has-feedback">
			<div class="password">
				...
				密码：<input type="password" class="input-large" id="password" placeholder="密码" name="password">
				<br><span style="color:red;">${errorMsg1}${errorMsg2}</span><br>
				<span></span><br>
			</div>
		</div>
		...
		<div class="form-group">
		    <span style="color:red;">${errorMsg3}${errorMsg4}</span><br>
